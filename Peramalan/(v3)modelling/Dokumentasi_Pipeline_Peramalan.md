...
| `frontend-streamlit.py` | Layar visualisasi antarmuka aplikasi (*Dashboard* Tesis) untuk menampilkan tren perbandingan algoritma secara estetik dan tabel rinci SKU berdasar metrik yang dpilih. |
